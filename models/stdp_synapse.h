...
stdp_synapse< targetidentifierT >::get_status( DictionaryDatum& d ) const
{
  ...
  def< double >( d, names::mu_noise, mu_noise_ );
  def< double >( d, names::sigma_noise, sigma_noise_ );
...
stdp_synapse< targetidentifierT >::set_status( const DictionaryDatum& d, ConnectorModel& cm )
{
  ...
  updateValue< double >( d, names::mu_noise, mu_noise_ );
  updateValue< double >( d, names::sigma_noise, sigma_noise_ );
